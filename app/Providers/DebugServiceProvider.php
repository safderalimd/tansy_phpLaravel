...
/**
 * This class extends laravel debugbar service provider.
 *
 * The intent is to make the debugbar appear only if a cookie is present.
 */
class DebugServiceProvider extends ServiceProvider
{
    ...
    {
        $debugbar = Cookie::get('enable_debugbar');
        if (!empty($debugbar)) {
            return true;
        }
    ...
    public function register()
    {
        ...
        $configPath = base_path('vendor/barryvdh/laravel-debugbar/config/debugbar.php');
        ...
        $this->app['command.debugbar.clear'] = $this->app->share(
            function ($app) {
                return new \Barryvdh\Debugbar\Console\ClearCommand($app['debugbar']);
            }
        );
