...
class SchoolProgress
{
    ...
    public function setExamTypes($types)
    {
        ...
        $skip = ['class_student_id', 'student_roll_number', 'student_full_name', 'subject_name', 'student_subject_max_total', 'subject_gpa', 'subject_short_code', 'subject_order', 'main_exam_name', 'student_entity_id', 'admission_number', 'class_name', 'subject_max_total', 'student_subject_percent'];
