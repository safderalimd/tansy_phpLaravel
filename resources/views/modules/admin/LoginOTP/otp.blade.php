    ...
    <div class="container">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                <div class="panel-heading text-center"><h4>Password OTP</h4></div>
                <div class="panel-body">
                    ...
                    <form action="{{ url('cabinet/otp') }}" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-md-12 text-right">
                                <div><a href="/cabinet/otp/resend">Resend SMS?</a></div>
                            </div>
                        </div>
