...
<div class="panel-group sch_class">
    <div class="panel panel-primary">
        <div class="panel-heading">
            ...
            <a href="{{url('/cabinet/account-client/create/')}}" class="btn pull-right btn-default">Add new record</a>
        </div>
            ...
            <table class="table table-striped table-bordered table-hover" data-datatable>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-default" href="{{url("/cabinet/account-client/edit/{$item['account_entity_id']}")}}" title="Edit">
                                <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                            </a>
                            <a class="btn btn-default formConfirm" href="{{url("/cabinet/account-client/delete/{$item['account_entity_id']}")}}"
                               title="Delete"
                               data-title="Delete Account Client"
