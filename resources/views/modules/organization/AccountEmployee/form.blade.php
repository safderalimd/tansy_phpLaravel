...
<div class="row"><div class="col-md-3 pull-left"><h3>Login</h3></div></div>
                        ...
                        <input type="text" name="tmp-name" placeholder="do not fill" style="position:absolute; left:-1000px; top:-1000px;">
                        <input type="password" name="tmp-pass" placeholder="do not fill" style="position:absolute; left:-1000px; top:-1000px;">
