...
<div id="mobile-panel" class="panel-group">
    <section class="panel">
        ...
        <header class="panel-heading">
            <h3 class="panel-header-text">Send Mail</h3>
        </header>
        ...
        <div class="panel-body">
            ...
            <form action="/cabinet/send-mail" class="form-inline" method="GET">
            ...
            <div class="inbox-list">
                ...
                @include('modules.communication.SendMail.messages')
...
@section('end-content')
    <div id="inbox-options">
        ...
        <form id="delete-messages-form" method="POST" action="/cabinet/send-mail/delete">
...
<script type="text/javascript">
    ...
    function openDetail(element, event)
    {
        ...
        window.location.href = "/cabinet/send-mail/detail?id="+id;
    }
