...
<head>
    ...
    <title>Database Server Error</title>
    <!-- Bootstrap core CSS -->
...
<body onload="javascript:loadDomain();">
    ...
    <div class="container">
        <!-- Jumbotron -->
        <div class="jumbotron">
            <h1><span class="glyphicon glyphicon-fire red"></span> Database Server Error</h1>
            <p class="lead">The database server is returning an error for <em><span id="display-domain"></span></em>.</p>
    ...
    <div class="container">
        <div class="body-content">
            <div class="row">
                <div class="col-md-6">
                    <h2>What happened?</h2>
                    <p class="lead">A database error implies there is a problem with the database server's software causing it to malfunction.</p>
                </div>
                <div class="col-md-6">
                    <h2>What can I do?</h2>
